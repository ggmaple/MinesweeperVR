...
namespace jp.yzroid.CsgUnitySweeper
{
    public class UiManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private Text mGameClearTimeText;
        [SerializeField]
        private Text mGameOverTimeText;
        ...
        public void RenewTimeText(int time)
        {
            ...
            mGameClearTimeText.text = string.Format("TIME: {0:00}:{1:00}", minutes, seconds);
            mGameOverTimeText.text = string.Format("TIME: {0:00}:{1:00}", minutes, seconds);
